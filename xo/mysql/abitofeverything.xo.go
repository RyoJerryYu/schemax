// Package mysql contains generated code for schema 'schemax'.
package mysql
...
// ABitOfEverything represents a row from 'schemax.a_bit_of_everything'.
type ABitOfEverything struct {
	...
	AJSON                    json.RawMessage `json:"a_json"`                      // a_json
	AJSONNullable            json.RawMessage `json:"a_json_nullable"`             // a_json_nullable
