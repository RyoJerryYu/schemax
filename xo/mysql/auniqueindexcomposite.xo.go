...
// AUniqueIndexComposite represents a row from 'schemax.a_unique_index_composite'.
type AUniqueIndexComposite struct {
	AKey1 sql.NullInt64 `json:"a_key1"` // a_key1
	AKey2 sql.NullInt64 `json:"a_key2"` // a_key2
}

// AUniqueIndexCompositeByAKey1AKey2 retrieves a row from 'schemax.a_unique_index_composite' as a [AUniqueIndexComposite].
//
...
func AUniqueIndexCompositeByAKey1AKey2(ctx context.Context, db DB, aKey1, aKey2 sql.NullInt64) (*AUniqueIndexComposite, error) {
	...
	const sqlstr = `SELECT ` +
		`a_key1, a_key2 ` +
		`FROM schemax.a_unique_index_composite ` +
