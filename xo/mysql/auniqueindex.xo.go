...
// AUniqueIndex represents a row from 'schemax.a_unique_index'.
type AUniqueIndex struct {
	AKey sql.NullInt64 `json:"a_key"` // a_key
}

// AUniqueIndexByAKey retrieves a row from 'schemax.a_unique_index' as a [AUniqueIndex].
//
