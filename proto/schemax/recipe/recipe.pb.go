...
var file_schemax_recipe_recipe_proto_rawDesc = []byte{
...
var (
	...
	file_schemax_recipe_recipe_proto_rawDescData = file_schemax_recipe_recipe_proto_rawDesc
)

func file_schemax_recipe_recipe_proto_rawDescGZIP() []byte {
	file_schemax_recipe_recipe_proto_rawDescOnce.Do(func() {
		file_schemax_recipe_recipe_proto_rawDescData = protoimpl.X.CompressGZIP(file_schemax_recipe_recipe_proto_rawDescData)
	})
...
func file_schemax_recipe_recipe_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_schemax_recipe_recipe_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_schemax_recipe_recipe_proto_rawDesc = nil
