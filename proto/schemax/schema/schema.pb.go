...
var file_schemax_schema_schema_proto_rawDesc = string([]byte{
...
var (
	...
	file_schemax_schema_schema_proto_rawDescData []byte
)

func file_schemax_schema_schema_proto_rawDescGZIP() []byte {
	file_schemax_schema_schema_proto_rawDescOnce.Do(func() {
		file_schemax_schema_schema_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_schemax_schema_schema_proto_rawDesc), len(file_schemax_schema_schema_proto_rawDesc)))
	})
...
func file_schemax_schema_schema_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_schemax_schema_schema_proto_rawDesc), len(file_schemax_schema_schema_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
